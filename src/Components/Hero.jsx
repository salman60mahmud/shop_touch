    ...
    return (
        <div className="hero">
            <div className="flex flex-1 flex-col justify-center gap-20 pl-60 leading-none">
                <h2 className="text-5xl sm:text-4xl font-semibold text-neutral-900">NEW ARRIVALS ONLY</h2>
                <div>
                    <div className="flex items-center gap-4">
                        <p className="text-7xl sm:text-5xl font-medium">New</p>
                        <img className="h-24 w-auto" src="/src/media/hand_icon.png" alt="hand-icon" />
                    </div>
                    <p className="text-7xl sm:text-5xl font-semibold sm:font-bold mt-4">Collections</p>
                    <p className="text-7xl sm:text-5xl font-semibold sm:font-bold mt-6">For Everyone</p>
                </div>
