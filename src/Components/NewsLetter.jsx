const NewsLetter = () => {
    return (
        <div className="flex justify-between items-center flex-col my-8 md:my-16 lg:my-30 p-6 sm:p-10 md:p-16 lg:p-20 bg-gradient-to-b from-[#bac8f3] from-30% via-[#d7bbd7] via-60% to-[#d7bbd7] w-[90%] sm:w-[80%] xl:w-[65%] h-auto md:h-[40vh] mx-auto rounded-lg md:rounded-2xl">
